  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="max-w-2xl">
        <CardHeader>
          <CardTitle>Wyszukiwanie prac naukowych</CardTitle>
          <CardDescription>
            Kliknij przycisk poniżej, aby uzyskać propozycje aktualizacji
            swojego profilu na podstawie danych w zewnętrznych systemach.
          </CardDescription>
        </CardHeader>
        <CardContent>
