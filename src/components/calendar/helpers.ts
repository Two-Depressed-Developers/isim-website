...
export function getEventBlockStyle(
  ...
  // Adjust for 7AM-9PM display (minutes from 7AM)
  const minutesFrom7AM = startMinutes - 7 * 60;
  const totalVisibleMinutes = 15 * 60; // 15 hours visible
  const top = (minutesFrom7AM / totalVisibleMinutes) * 100;
